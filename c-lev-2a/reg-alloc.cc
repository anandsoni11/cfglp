...
void Machine_Description::initialize_instruction_table()
{
	...
	spim_instruction_table[cast_to_float] = new Instruction_Descriptor(cast_to_float, "mtc1", "mtc1", "",  i_r_op_o1, a_op_o1_r);
	spim_instruction_table[cast_to_int] = new Instruction_Descriptor(cast_to_int, "mfc1", "mfc1", "",  i_r_op_o1, a_op_o1_r);
