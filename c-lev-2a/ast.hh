...
static map<int, Tgt_Op> arith_tgtop_map = {{0, op_uminus}, {1, op_add}, {2, op_sub}, {3, op_mul}, {4, op_div}};
static map<int, Tgt_Op> arith_tgtop_map_double = {{0, op_uminus_d}, {1, op_add_d}, {2, op_sub_d}, {3, op_mul_d}, {4, op_div_d}};
...
public:
	Arithmetic_Expr_Ast(Ast * temp_lhs, Ast * temp_rhs, int temp_op, int line);
	~Arithmetic_Expr_Ast();
...
public:
	Type_Cast_Ast(Ast * temp_expression, Data_Type type, int line);
	~Type_Cast_Ast();
