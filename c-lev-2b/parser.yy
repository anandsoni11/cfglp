...
expression:
    ...
    if (NOT_ONLY_PARSE)
	{
        $$ = new Type_Cast_Ast($4, int_data_type, get_line_number());
    }
    }
|
    ...
    if (NOT_ONLY_PARSE)
	{
		 $$ = new Type_Cast_Ast($4, float_data_type, get_line_number());
    }
    }
|
    ...
    if (NOT_ONLY_PARSE)
	{
		 $$ = new Type_Cast_Ast($4, double_data_type, get_line_number());
    }
    }
|
	rel_expression
    ...
    if (NOT_ONLY_PARSE)
	{
		//cout  << "parsed the relational condition " <<endl;
        $$ = $1;
    }
    }
|
...
|
    ...
    if (NOT_ONLY_PARSE)
	{
		//cout  << "parsed the unary expression" <<endl;
        $$ = $1;
    }
    }
;
...
|
    ...
    if (NOT_ONLY_PARSE)
	{
        $$ = new Arithmetic_Expr_Ast(NULL, $2, 0, get_line_number());
		$$->check_ast();
    }
    }
;
...
arith_expression:
    ...
    if (NOT_ONLY_PARSE)
	{
        $$ = new Arithmetic_Expr_Ast($1, $3, 1, get_line_number());
		$$->check_ast();
    }
    }
|
    ...
    if (NOT_ONLY_PARSE)
	{
        $$ = new Arithmetic_Expr_Ast($1, $3, 2, get_line_number());
		$$->check_ast();
    }
    }
|
    ...
    if (NOT_ONLY_PARSE)
	{
        $$ = new Arithmetic_Expr_Ast($1, $3, 3, get_line_number());
		$$->check_ast();
    }
    }
|
    ...
    if (NOT_ONLY_PARSE)
	{
        $$ = new Arithmetic_Expr_Ast($1, $3, 4, get_line_number());
		$$->check_ast();
    }
    }
;
